 ...
 * The Game class provides an interactive game skeleton. It facilitates the frame rate (fps) control and input interface.
 * 
 * @author vanting
 */
public class GameDemo extends Game {
    ...
    */
    private Image img1 = Console.loadImage("/student/demo/img/invader_1.png");
    private Image img2 = Console.loadImage("/student/demo/img/invader_2.png");
    ...
    */
    ...
    /************************************************************************************************
    There are three abstract methods must be overridden:
